# Migration Guide v1.0 - Overview

# Overview | v1 Migration Guide

Mastra v1 Beta: Overview of breaking changes when upgrading to Mastra v1.

Source: https://mastra.ai/guides/v1/migrations/upgrade-to-v1/overview

---

# Upgrade to Mastra v1

First update to latest 0.x version Before upgrading to v1, make sure you've updated to the latest 0.x version of Mastra. Follow the [upgrade to latest 0.x guide](https://mastra.ai/guides/migrations/upgrade-to-latest-0x)first, then return here to complete the v1 migration. 
...
## Migration StrategyDirect link to Migration Strategy

### Update all Mastra packages to beta tagDirect link to update-all-mastra-packages-to-beta-tag
...
### Update Node.js versionDirect link to Update Node.js version

Mastra v1 requires Node.js **22.13.0**or higher. Update your development and production environments accordingly. 

### Go through migration checklistDirect link to Go through migration checklist
...
## Breaking Changes by AreaDirect link to Breaking Changes by Area
...
## Migration ChecklistDirect link to Migration Checklist
...
### High Impact ChangesDirect link to High Impact Changes
...
### Medium Impact ChangesDirect link to Medium Impact Changes
...
### Low Impact ChangesDirect link to Low Impact Changes

- Rename createRunAsync to createRun - Workflows
- Update voice package names from @mastra/speech-* to @mastra/voice-* - Voice Packages
- Update scorer methods: runExperiment → runEvals, getScorerByName → getScorerById - Evals & Scorers
