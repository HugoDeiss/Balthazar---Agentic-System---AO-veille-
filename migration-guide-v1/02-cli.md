# Migration Guide v1.0 - CLI

# CLI | v1 Migration Guide

Mastra v1 Beta: Learn how to migrate CLI changes when upgrading to v1.

Source: https://mastra.ai/guides/v1/migrations/upgrade-to-v1/cli
...
```
- mastra build --env production+ mastra build+ mastra start --env production
```
...
```
const mastra = new Mastra({  server: {    port: 3001,  },});
```
